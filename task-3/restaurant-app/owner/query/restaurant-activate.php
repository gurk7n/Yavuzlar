...
<head>
    ...
    <title>Restoran - Restoran Aktifleştir</title>
...
try {
    $activateStmt = $pdo->prepare("UPDATE restaurant SET deleted_at = NULL WHERE id = :id");
    ...
    echo "<script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script>
          <script>
            Swal.fire({
                title: 'Başarılı!',
                text: 'Restoran başarıyla aktif hale getirildi.',
                icon: 'success',
                confirmButtonText: 'Tamam'
            }).then(() => {
                window.location.href = '../restaurants.php';
