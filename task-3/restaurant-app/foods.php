...
$stmtFoods = $pdo->prepare("SELECT id, name, description, image_path, price, discount FROM food WHERE deleted_at IS NULL AND name LIKE :searchTerm");
$stmtFoods->execute([':searchTerm' => '%' . $searchTerm . '%']);
  ...
  <div id="layoutSidenav_content">
    <main>
      <div class="container-fluid px-4">
        <h1 class="my-4">Yemekler</h1>
        
        <form class="mb-4" method="get" action="">
          <div class="input-group">
            <input type="text" class="form-control" name="search" placeholder="Yemek ara" value="<?php echo htmlspecialchars($searchTerm); ?>">
